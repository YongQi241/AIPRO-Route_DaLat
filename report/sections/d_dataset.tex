...
khung nhỏ nhất bảo đảm toàn bộ mạng liên thông; các cặp gần nhất còn lại được
thêm cho đến khi đạt mục tiêu 60 cạnh có hướng.
...
Sau tiền xử lý, backend dùng 25 đỉnh, 60 cạnh có hướng và 300 bản ghi điều
kiện (60 cạnh nhân với 5 kịch bản). Các file CSV và GeoJSON sinh ra dùng chung
...
Khoảng cách cạnh bao gồm cả hai đoạn nối từ tọa độ địa điểm đến đỉnh đường đã
ghép. Kiểm tra trên dữ liệu sinh hiện tại không phát hiện cạnh nào có
\texttt{distance\_km} nhỏ hơn khoảng cách Haversine giữa hai đầu mút. Kiểm tra
mọi cặp đỉnh trong năm kịch bản cũng không phát hiện trường hợp heuristic
Haversine đánh giá vượt chi phí đường đi ngắn nhất theo khoảng cách.
...
\midrule
E001 & DL01 $\rightarrow$ DL05 & 2,460 & 5,25 & residential, secondary, trunk \\
E002 & DL05 $\rightarrow$ DL01 & 2,460 & 5,25 & residential, secondary, trunk \\
E003 & DL01 $\rightarrow$ DL06 & 6,253 & 10,08 & residential, secondary \\
E004 & DL06 $\rightarrow$ DL01 & 6,258 & 10,08 & residential, secondary \\
E005 & DL01 $\rightarrow$ DL14 & 7,619 & 16,52 & primary, residential, secondary, trunk, unclassified \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}[itemsep=2pt]
  ...
  \item Mỗi cạnh gồm tuyến đường OpenStreetMap và hai đoạn nối từ địa điểm đến
  đỉnh đường đã ghép. Khoảng cách, thời gian và hình học đều bao gồm các đoạn
  nối này; tốc độ giả định trên đoạn nối là 15 km/h.
\end{itemize}
