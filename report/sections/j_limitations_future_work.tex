...
\begin{itemize}[itemsep=2pt]
  \item \textbf{Tập dữ liệu:} chỉ có 25 địa điểm và 60 cạnh giữa các điểm quan
  tâm, không phải toàn bộ mạng giao lộ Đà Lạt. Hình học được giản lược bằng
  Douglas--Peucker nhưng vẫn bám theo tuyến đường và các đoạn nối địa điểm.
