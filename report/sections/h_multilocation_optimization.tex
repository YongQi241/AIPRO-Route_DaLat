...
\midrule
Thứ tự ban đầu & DL01 $\rightarrow$ DL03 $\rightarrow$ DL07 $\rightarrow$ DL15 & 1,090455 \\
Thứ tự đã tối ưu & DL01 $\rightarrow$ DL07 $\rightarrow$ DL03 $\rightarrow$ DL15 & 0,857122 \\
\bottomrule
\end{tabular}
\end{table}

Với kịch bản S0 và cấu hình \texttt{balanced}, duyệt cạn xét đủ sáu hoán vị
và giảm chi phí từ 1,090455 xuống 0,857122, tương đương \textbf{21,40\%}.
...
\begin{itemize}[itemsep=2pt]
  ...
  DL03 $\rightarrow$ DL15 $\rightarrow$ DL07 và đạt chi phí 0,929595, cao hơn
  nghiệm chính xác 0,857122 khoảng 8,46\%, nhưng không phải xét mọi hoán vị.
\end{itemize}
