...
\begin{figure}[H]
  \centering  
  \includegraphics[width=\linewidth]{images/screenshot_main_window.png}
  \caption{giao diện chính sau khi đồ thị được tải;}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{images/screenshot_multi_location.png}
  \caption{tuyến cuối cùng cho lộ trình đa địa điểm, chỉ số và thẻ kết quả sau khi mô phỏng hoàn tất}
\end{figure}
