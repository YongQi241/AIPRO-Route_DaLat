...
\begin{enumerate}[itemsep=3pt]
  ...
  UCS, Dijkstra, A*, Láng giềng gần nhất, Leo đồi và TSP duyệt cạn. Backend còn
  hỗ trợ Tham Lam ưu tiên tốt nhất qua API nhưng thanh bên chưa có lựa chọn này.
  ...
  được giãn đều. Dùng nút $+$/$-$ hoặc con lăn để phóng to, thu nhỏ; giữ chuột
...
$\rightarrow$ DL09 \\
Tuyến nút đầy đủ & DL01 $\rightarrow$ DL02 $\rightarrow$ DL22
...
91.424 phút trong lần thử này, với thời gian xử lý 4.965 ms. Kết quả TSP duyệt
