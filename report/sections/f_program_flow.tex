...
Backend công bố chín thuật toán qua API, trong đó Tham Lam ưu tiên tốt nhất có trong
backend nhưng chưa có thẻ chọn ở \texttt{AlgorithmSidebar.jsx}. Giao diện hiện
cho chọn tám thuật toán: BFS, DFS, UCS, Dijkstra, A*, Láng giềng gần nhất, Leo
đồi và TSP duyệt cạn. Láng giềng gần nhất và TSP duyệt cạn là hai chế độ
...
cục liên kết xác định để giãn đều nút nhưng vẫn giữ các kết nối có hướng. Người
